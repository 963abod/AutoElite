...
import { MapPin, Phone, Layers } from 'lucide-react';
  ...
  return (
    <header className="sticky top-0 z-40 w-full bg-[#F8F9FA]/90 backdrop-blur-md border-b border-neutral-200/80">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
        ...
        {/* Tactile Architectural Segmented Mode Switcher */}
        ...
        <div className="hidden md:flex items-center gap-6">
          ...
          <div className="flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-white border border-neutral-200 text-xs text-neutral-800">
            ...
            >
              <option value="All Locations" className="bg-white text-neutral-900">All Showrooms</option>
          ...
          {comparedCount > 0 && (
            ...
            >
              ...
              <span className="uppercase tracking-wider text-[10px]">Compare</span>
